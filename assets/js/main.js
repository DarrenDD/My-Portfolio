...
// Previously selectied topic(if user selected)
...
//Acticate/deactivate the theme manually with the button
themeButton.addEventListener('click', () =>{
    // Add or remove the dark / icon theme
    document.body.classList.toggle(darkTheme)
    themeButton.classList.toggle(iconTheme)
    // we save the them and the current icon that thte user chose
